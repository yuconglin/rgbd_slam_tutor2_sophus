...
public:
    ...
    static g2o::SE3Quat SE3toSE3Quat(const SE3d& T)
    {
        return g2o::SE3Quat (T.rotationMatrix(), T.translation());
    }

    static SE3d SE3Quat2SE3(const g2o::SE3Quat& T)
    {
        return SE3d(T.rotation(), T.translation());
    }

    static Eigen::Isometry3d SE3toIsometry(const SE3d& T)
    {
        Eigen::Isometry3d result = (Eigen::Isometry3d) T.rotationMatrix();
