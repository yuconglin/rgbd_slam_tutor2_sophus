...
public:
    ...
    void    shutdown()
    {
        ...
        save( "/home/ylin67/rgbdslam_catkin_ws/src/rgbd-slam-tutor2-sophus/data/traj.g2o" );
    ...
    void save( const string& filename )
    {
        ...
        */
        ...
        for ( size_t i=0; i< keyframes.size(); i++ )
        {
            ...
            v->getEstimateData( data );
            //fout<<"VERTEX_SE3:QUAT "<<v->id()<<" ";
            f << std::setprecision(15) << keyframes[i]->timestamp << " ";
            for ( double d:data )
                f << std::setprecision(5) << d << " ";
            f << endl;
        }
        f.close();
